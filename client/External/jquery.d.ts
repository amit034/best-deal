...
declare module BD {
    ...
    interface JQueryAjaxSettings {
        ...
        async?: boolean;
        /**
         * A pre-request callback function that can be used to modify the jqXHR (in jQuery 1.4.x, XMLHTTPRequest) object before it is sent. Use this to set custom headers, etc. The jqXHR and paths objects are passed as arguments. This is an Ajax Event. Returning false in the beforeSend function will cancel the request. As of jQuery 1.5, the beforeSend option will be called regardless of the type of request.
         */
    ...
    interface JQueryStatic {
         ...
         *
         * @param settings A set of key/value pairs that configure the Ajax request. All paths are optional. A default can be set for any option with $.ajaxSetup().
         */
