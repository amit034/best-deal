...
module BD.APP.Common {
    ...
    export class LocaleHelper {
        ...
        static getStringMapForCountry(country:string, stringMapArray:IStringMap, defaultLang:string = "en"):{[key:string]: string} {
            ...
            return Collection.hashSelect(stringMap, (langStrings:{[lang:string]: string}) => Collection.of(langs).selectFirst((lang:string) => langStrings[lang], (v) => v && v.length > 0));
        }
